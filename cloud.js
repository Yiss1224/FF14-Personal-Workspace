...
function ff14TcApply(){if(ff14TcApplying)return;ff14TcApplying=true;try{ff14TcLoadCache();ff14TcApplyFishRows();const route=document.getElementById('fish-route-result');if(route)ff14TcWalkText(route)}finally{ff14TcApplying=false}}
