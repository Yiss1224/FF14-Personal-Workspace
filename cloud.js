...
const FF14_SYNC_KEYS=['roulettes','dailyDone','levelPlan','levelJobs','levelSchedulerSettings','levelMultiPlan','fishHistory','fishTarget','fishCurrentCount','fishcakeCaughtIds','fishCaughtIds','fishSkippedIds'];
...
function rerenderCloudState(){if(typeof window.renderFF14All==='function')window.renderFF14All();if(typeof window.renderLevelScheduler==='function')window.renderLevelScheduler()}
