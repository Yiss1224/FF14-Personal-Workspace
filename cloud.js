...
const FF14_SYNC_KEYS=['roulettes','dailyDone','levelPlan','fishHistory','fishTarget','fishCurrentCount','fishcakeCaughtIds','fishCaughtIds','fishSkippedIds'];
...
function applyCloudSnapshot(p){
  ...
  if(changed&&typeof window.renderFF14All==='function')window.renderFF14All();return changed;
}
function authUi(){
